...
public class SocketMain {
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			final Socket socket = IO.socket("https://websocket.btcchina.com",
					opt);
			socket.on(Socket.EVENT_CONNECT, new Emitter.Listener() {
				...
				public void call(Object... args) {
					...
					socket.emit("subscribe", "marketdata_cnyltc"); // subscribe
																	// another
																	// market
					socket.emit("subscribe", "grouporder_cnybtc"); // subscribe
																	// grouporder
					socket.emit("subscribe", "grouporder_cnyltc"); // subscribe
																	// another
																	// market
				...
				@Override
				public void call(Object... args) {
					JSONObject json = (JSONObject) args[0];// receive your order
															// feed
					System.out.println(json);
				}
				...
				@Override
				public void call(Object... args) {
					JSONObject json = (JSONObject) args[0];// receive your
															// account_info feed
					System.out.println(json);
				}
			...
			Logger.getLogger(SocketMain.class.getName()).log(Level.SEVERE,
					null, ex);
		}
	}
	...
	public String get_payload() throws Exception {
		postdata = "{\"tonce\":\""
				...
				+ tonce.toString()
				+ "\",         \"method\": \"subscribe\", \"params\": [\"trade\",\"ticker\",\"grouporder\",\"order\",\"order_cnyltc\",\"account_info\"]}";// subscribe
																											// order
																											// feed
																											// for
																											// cnyltc
	...
	public String get_sign() throws Exception {
		String params = "tonce=" + tonce.toString() + "&accesskey="
				+ ACCESS_KEY + "&requestmethod=post&id=" + tonce.toString()
				+ "&method=subscribe&params=trade,ticker,grouporder,order,order_cnyltc,account_info"; // subscribe
																		// the
																		// order
																		// of
